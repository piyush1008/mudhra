export default function Contact(){
    return(
        <div className="flex justify-center pt-16 mt-20">
                    ...
                    <div className="container px-6 py-12 mx-auto">
                        ...
                        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <p className="mt-2 text-blue-500 dark:text-blue-400">piyushsunnyst@gmail.com</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <p className="mt-2 text-blue-500 dark:text-blue-400">Trivenipuram Jhunsi Prayagraj, 211019</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <p className="mt-2 text-blue-500 dark:text-blue-400">+(91) 8707595098</p>
                            </div>
                        </div>
                    </div>
                </section>
